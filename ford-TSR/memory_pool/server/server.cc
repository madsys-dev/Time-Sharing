...
void Server::InitRDMA() {
  ...
  RDMA_ASSERT(
    ...
    // RDMA_ASSERT(
    //   rdma_ctrl->register_memory(SERVER_TSR_BUFF_ID, tsr_flag, 1, rdma_ctrl->get_device()) == true);
...
int main(int argc, char* argv[]) {
  ...
  std::string config_filepath = "/mnt/memory_node_config.json";
