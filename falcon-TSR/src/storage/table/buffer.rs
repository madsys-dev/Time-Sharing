...
impl Table {
    pub fn set_pool_size(&mut self, size: usize) {
        ...
        for i in 0..TRANSACTION_COUNT {
            buffer_pointer.push(RwLock::new(size / TRANSACTION_COUNT * i));
        }
    ...
    pub fn get_tuple_buffer(
        ...
        // file::sfence();
        // println!("save nvm_id {} {}", pointer, tuple._address());
        ...
        // println!("tsp buffer p time {:?}", a2.duration_since(a1).unwrap());
