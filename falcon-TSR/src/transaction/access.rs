...
use crate::transaction::transaction::LogStruct;
...
impl<'a> AccessStruct<'a> {
    ...
    pub fn finish(&self, thread_id: usize, cur_min_txn: u64) {
        ...
        {
            if self.tuple_id.get_address() & POW_2_63 == 0 {
    ...
    pub fn do_update(
        ...
        if !self.is_insert && self.column_id != DELETE_COLUMN_FLAG {
            ...
            #[cfg(feature = "buffer_pool")]
            {
                ...
                logs.push(LogStruct {
                    tuple_id: vec.nvm_id.load(Ordering::Relaxed),
                    column_id: self.table.schema.get_column_offset(column_id).start as u64,
        ...
        // println!("ret 1111");
            ...
            #[cfg(feature = "buffer_pool")]
            {
                ...
                self.table
                    .remove_tuple_buffer(&self.tuple_id, thread_id, &tuple)
                    .unwrap();
                // file::sfence();
                // tuple.set_lock_tid(0);
                return vec.nvm_id.load(Ordering::Relaxed);
